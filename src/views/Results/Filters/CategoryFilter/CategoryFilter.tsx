    ...
    return (
      <div className="flex-col flex-col--5 flex-col--mobile--12">
        <div className="flex-container flex-container--mobile-no-padding category__filters">
          <div className="flex-col flex-col--4 flex-col--tablet--3 flex-col--mobile--6 flex-container--mobile-no-padding">
          ...
          <div className="flex-col flex-col--7 flex-col--tablet--9 flex-col--mobile--6 flex-container--mobile-no-padding view-filter__search-bar">
