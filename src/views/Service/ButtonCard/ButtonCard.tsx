...
const ButtonCard: React.FunctionComponent<IProps> = ({ serviceStore }) => (
  <div className="flex-container flex-container--justify flex-container--no-padding service__button-container">
    <div className="flex-col flex-col--mobile--12 flex-col--5 flex-col--tablet--4 service__button-container--mobile">
      <Button text="Print" icon="print" alt={true} onClick={() => window.print()} />
    </div>
    <div className="flex-col flex-col--mobile--12 flex-col--7 flex-col--tablet--4">
      <Button
